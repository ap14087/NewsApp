...
import utilPackage.ConstantUsed
import utilPackage.ConstantUsed.Companion.SEARCH_NEWS_TIME_DELAY
...
class searchNewsFragment : Fragment(R.layout.fragment_search_news) {
            ...
            when(response){
                is ResourceUsed.Success ->{
                    ...
                    response.data?.let {newsResponse ->
                        ...
                        val totalPage = newsResponse.totalResults/ ConstantUsed.QUERY_PAGE_SIZE + 2
    ...
    val scrollListener = object : RecyclerView.OnScrollListener(){
        ...
        override fun onScrolled(recyclerView: RecyclerView, dx: Int, dy: Int) {
            ...
            val isTotalMoreThanVisible = totalItemCount >= ConstantUsed.QUERY_PAGE_SIZE
